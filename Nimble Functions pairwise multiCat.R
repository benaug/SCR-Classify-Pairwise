  ...
  run = function() {
    ...
    for(l in 1:n.samples){
      ...
      if(model$ID[l]!=pick){ #skip if propose same ID.
        ...
        these.matches <- map.match[l,]
        these.scores <- c(map.score[,l,])
        ...
        # model[["y.true"]][ID.curr,this.j[l]] <<- mvSaved["y.true",1][ID.cand,this.j[l]]
        # model[["y.true"]][ID.cand,this.j[l]] <<- mvSaved["y.true",1][ID.curr,this.j[l]]
        ...
        model$calculate(calcNodes.match.type[these.matches])
